...
### 6.3 Salvar o arquivo Markdown intermediário

Usar a ferramenta **Write** para salvar o texto completo do Capítulo 7 em arquivo Markdown no diretório de saída. O arquivo Markdown é o arquivo-fonte de todas as conversões e deve ser mantido pelo usuário para edições futuras.

**Caminho:** `C:\Users\aldem\capitulo-07-riscos-beneficios_[AAAAMMDD].md`

Cabeçalho YAML a inserir no topo do arquivo:

```yaml
---
title: "Capítulo 7. Análise dos Riscos e dos Benefícios"
lang: pt-BR
---
```
...
### 6.4 Gerar o arquivo DOCX

```bash
pandoc "C:\Users\aldem\capitulo-07-riscos-beneficios_[AAAAMMDD].md" \
  -o "C:\Users\aldem\capitulo-07-riscos-beneficios_[AAAAMMDD].docx" \
  --metadata title="Capítulo 7. Análise dos Riscos e dos Benefícios" \
  -V lang=pt-BR
```
...
### 6.5 Gerar o arquivo PDF

O PDF do Capítulo 7 deve conter, em todas as páginas: **cabeçalho centralizado** com o texto "Capítulo 7. Análise dos Riscos e dos Benefícios" e **numeração de página** no rodapé direito.

Tentar os mecanismos de conversão na ordem abaixo, usando o primeiro que estiver disponível no sistema:

**Opção A: wkhtmltopdf** (recomendado; suporte nativo a cabeçalho e rodapé; instalar em https://wkhtmltopdf.org/downloads.html se necessário):

```bash
# Passo 1: gerar HTML a partir do Markdown
pandoc "C:\Users\aldem\capitulo-07-riscos-beneficios_[AAAAMMDD].md" \
  -o "C:\Users\aldem\capitulo-07-riscos-beneficios_[AAAAMMDD].html" \
...
wkhtmltopdf \
  --header-center "Capítulo 7. Análise dos Riscos e dos Benefícios" \
  ...
  --margin-left 30mm \
  --margin-right 20mm \
  "C:\Users\aldem\capitulo-07-riscos-beneficios_[AAAAMMDD].html" \
  "C:\Users\aldem\capitulo-07-riscos-beneficios_[AAAAMMDD].pdf"
```
...
Escrever o arquivo `cap7-header.tex` com a ferramenta Write antes da conversão:

```latex
\usepackage{fancyhdr}
\pagestyle{fancy}
\fancyhf{}
\fancyhead[C]{\small Capítulo 7. Análise dos Riscos e dos Benefícios}
\fancyfoot[R]{\thepage}
...
```bash
pandoc "C:\Users\aldem\capitulo-07-riscos-beneficios_[AAAAMMDD].md" \
  -o "C:\Users\aldem\capitulo-07-riscos-beneficios_[AAAAMMDD].pdf" \
  --pdf-engine=xelatex \
  --include-in-header="[diretório]/cap7-header.tex" \
  -V lang=pt-BR \
  -V fontsize=12pt \
...
pandoc "C:\Users\aldem\capitulo-07-riscos-beneficios_[AAAAMMDD].md" \
  -o "C:\Users\aldem\capitulo-07-riscos-beneficios_[AAAAMMDD].html" \
  --standalone --embed-resources \
  --css="[diretório]/academico-cap7.css" \
  --metadata title="Capítulo 7. Análise dos Riscos e dos Benefícios" \
  -V lang=pt-BR

"C:/Program Files/Google/Chrome/Application/chrome.exe" \
  --headless=new --no-sandbox --disable-gpu \
  --print-to-pdf="C:\Users\aldem\capitulo-07-riscos-beneficios_[AAAAMMDD].pdf" \
  "C:\Users\aldem\capitulo-07-riscos-beneficios_[AAAAMMDD].html"
```

O arquivo `academico-cap7.css` deve incluir:

```css
@page {
  margin: 30mm 20mm 25mm 30mm;
  @top-center {
    content: "Capítulo 7. Análise dos Riscos e dos Benefícios";
...
**Se nenhum mecanismo de PDF estiver disponível:** informar ao usuário que o DOCX foi gerado com sucesso e orientá-lo a usar **"Arquivo / Baixar como / PDF"** (Google Docs) ou **"Arquivo / Salvar como / PDF"** (Word) para obter o PDF manualmente. Nesse caso, orientar a inserir manualmente o cabeçalho "Capítulo 7. Análise dos Riscos e dos Benefícios" e a numeração de páginas pelo menu de configuração de página do editor.
